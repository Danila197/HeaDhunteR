    ...
    card.insertAdjacentHTML('afterbegin', `   
            <article class="vacancy">
                ...
                <div class="vacancy__wrapper-btn">
                    <a class="vacancy__response vacancy__open-modal" href="#"
                        data-vacancy="${id}">Откликнуться</a>
...
const createModal = (data) => {
    ...
    const closeButtomElem = document.createElement('button');
    closeButtomElem.classList.add('modal__close');
    closeButtomElem.textContent = '✕';
    ...
    const submitButtomElem = document.createElement('button');
    submitButtomElem.classList.add('modal__response');
    submitButtomElem.textContent = 'Отправить резюме';
